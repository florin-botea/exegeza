...
<body>
		...
		<div class="row">
			...
			<div role="main" class="col-sm-9 order-1">
				<card p-if="!empty($breadcrumbs)" class="card-breadcrumb">
					<tpl is="partials/breadcrumb" :links="$breadcrumbs"></tpl>
				</card>

				<slot></slot>

                <tpl p-if="$hasArticles && isset($last_articles) && isset($popular_articles) && count($last_articles) && count($popular_articles)">
                        ...
                        <div class="lg:pr-2 flex flex-wrap">
                            <section role="last-articles-list" class="w-full lg:w-2/3 sm:pr-4 bg-gray-200">
                                ...
                                <ul class="text-justify leading-tight p-1">
                                    <tpl p-foreach="$last_articles as $article">
                                        <li class="pr-2" >
                            ...
                            <section class="w-full lg:w-1/3 bg-gray-300">
                                ...
                                <ul class="text-justify leading-tight p-1">
                                    <tpl p-foreach="$popular_articles as $article">
                                        <li class="">
					...
					<div p-if="in_array(request()->route()->getName(), [null, 'bible-versions.show', 'bible-versions.books.show', 'bible-versions.books.chapters.show', 'articles.show'])" class="mt-4">
						<tpl is="partials/subscribe-form"></tpl>
						<hr>
					</div>
				</tpl>
			</div>
	...
	<script p-if="!empty($body_scripts)" p-foreach="$body_scripts as $bscript">@php echo $bscript; @endphp</script>
