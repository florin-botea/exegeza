<section class="flex mb-4 flex-wrap">
    ...
    <div class="flex-1 flex w-full md:w-auto">
        <div role="box" class="border-4 border-purple-400 w-full self-center rounded shadow-md">
            ...
            <p class="p-4">It is a long established fact that a reader will be distracted</p>
            <form class="flex px-4 pb-4">
                <input type="email" placeholder="your@email.com" class="shadow-md input-w-full px-3 py-1 rounded-left border-r-0 border-2 border-purple-800 focus:outline-none text-purple-800 font-bold">
                <button type="submit" class="shadow-md rounded-right border-l-0 border-2 border-purple-800 bg-purple-800 text-white font-bold">
